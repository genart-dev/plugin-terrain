...
const RIVER_PROPERTIES: LayerPropertySchema[] = [
  ...
  { key: "widthNear", label: "Width (Near)", type: "number", default: 140, min: 10, max: 500, step: 5, group: "shape" },
  { key: "widthFar", label: "Width (Far)", type: "number", default: 8, min: 2, max: 100, step: 1, group: "shape" },
